...
const thumbnailTags = ['Graphic Design', 'Social Content', 'Interaction Design'];

function ThumbnailPage() {
  return (
    <div className="min-h-screen bg-glow px-6 py-8 text-ink md:px-10 lg:px-12">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8">
          <h1 className="font-sans text-5xl font-bold leading-none tracking-[-0.04em] text-ink md:text-7xl">
            Projects.
          </h1>
        </div>
        <ProjectThumbnailCard
          ...
          subtitle="A Soft Adoption Campaign"
          description="Animal adoption campaign concept with soft storytelling, social content, and a warm editorial visual style."
          tags={thumbnailTags}
        />
      </div>
    </div>
...
function App() {
  ...
  const isThumbnailPage = window.location.pathname === '/thumbnail';
